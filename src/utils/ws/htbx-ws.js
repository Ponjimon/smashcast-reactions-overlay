...
var HtbxWs = function (_EventEmitter) {
    _inherits(HtbxWs, _EventEmitter);

    function HtbxWs() {
        _classCallCheck(this, HtbxWs);

        var _this = _possibleConstructorReturn(this, (HtbxWs.__proto__ || Object.getPrototypeOf(HtbxWs)).call(this));
    ...
    _createClass(HtbxWs, [{
        ...
        value: function reconnect() {
            ...
            getServersObservable().first().subscribe(function (servers) {
                ...
                _this2.connectWs((0, _lodash.sample)(_this2.servers));
            }, console.error);

            function getServersObservable() {
                if (!(0, _utils.supportsWebSockets)()) {
                    return _rxjs.Observable.of([_config.FALLBACK_SERVER]).delay(0); // make it async
                }

                return _rxjs.Observable.ajax({
                    method: 'GET',
            ...
            function onDrop(reason) {
                ...
                function handleReconnect() {
                    if (this.connectionTries < this.connectionServerRetryLimit) {
                        var willReconnectTo = (0, _lodash.sample)((0, _lodash.without)(this.servers, this.currentServer)) || this.currentServer;
        ...
        value: function on(event, callback) {
            _get(HtbxWs.prototype.__proto__ || Object.getPrototypeOf(HtbxWs.prototype), 'on', this).call(this, event, callback);
        ...
        value: function observe(eventName) {
            return _rxjs.Observable.fromEvent(this, eventName);
        }
    }]);
...
//# sourceMappingURL=htbx-ws.js.map
